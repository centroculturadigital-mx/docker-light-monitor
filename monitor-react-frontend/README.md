# Dashboard de monitor de contenedores docker
...
Abre [https://test.centroculturadigital.mx](https://test.centroculturadigital.mx) para verla en tu navegador.
...
No necesitas usar `eject` nunca. El conjunto de características curadas es adecuado para despliegues pequeños y medianos, y no deberías sentirte obligado a usar esta función. Sin embargo, entendemos que esta herramienta no sería útil si no pudieras personalizarla cuando estés listo para hacerlo.
